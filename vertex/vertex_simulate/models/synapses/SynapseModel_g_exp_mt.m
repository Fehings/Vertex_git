classdef SynapseModel_g_exp_mt < SynapseModel_g_exp & STPModel_mt
  %SynapseModel_g_exp_mt Conductance-based single exponential synapses with
  %STP


  
  methods
    function SM = SynapseModel_g_exp_mt(Neuron, CP, SimulationSettings, ...
