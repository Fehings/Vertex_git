classdef SynapseModel_i_exp_mt < SynapseModel_i_exp & STPModel_mt
  ...
  methods
    function SM = SynapseModel_i_exp_mt(Neuron, CP, SimulationSettings, ...
    ...
    function [SM] = bufferIncomingSpikes(SM, synIndeces, weightsToAdd, preInd,groupID)
        ...
        SM.i_expEventBuffer(synIndeces) = ...
                            SM.i_expEventBuffer(synIndeces) + weightsToAdd.*(SM.y(preInd));
  ...
  methods(Static)
      function params = getRequiredParams()
          params = [SynapseModel_i_exp.getRequiredParams STPModel_mt.getSTPParams()];
      end
