...
for iComp = 1:NP.numCompartments
  plot3(NP.compartmentXPositionMat(iComp,:), ...
        ...
        'Color',cmap(scaled_vm(iComp),:), ...
        'LineWidth',NP.compartmentDiameterArr(iComp)*3);
end
% if isfield(Results.params,'TissueParams')
%     if isfield(Results.params.TissueParams,'StimulationField')
%         if isa(Results.params.TissueParams.StimulationField, 'pde.StationaryResults')
%         else
