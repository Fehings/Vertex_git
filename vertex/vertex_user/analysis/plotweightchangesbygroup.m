...
w2 = getSparseConnectivityWeights(Results.weights_arr{3}, Results.syn_arr, Results.params.TissueParams.N);
w3 = getSparseConnectivityWeights(Results.weights_arr{6}, Results.syn_arr, Results.params.TissueParams.N);
wd = w3-w2;
wchange = sum(wd);
