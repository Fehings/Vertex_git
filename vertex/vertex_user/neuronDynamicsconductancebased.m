function [v_m, I,NeuronModel, InputModel, NParams,spikes, cai] = neuronDynamicsconductancebased(NeuronParams, pars)
...
cai = zeros(simulationSteps,number);
...
for simStep = 1:simulationSteps
  ...
  spikes = [spikes NeuronModel{1}.spikes];
  v_m(:, :, simStep) = NeuronModel{1}.v;
  cai(simStep) = NeuronModel{1}.cai;
