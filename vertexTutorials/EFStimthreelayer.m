...
NeuronParams(1).v_cutoff = -10;
    ...
    NeuronParams(1).phi = 0.1;
    NeuronParams(1).T0 = 0.08;
    NeuronParams(1).g_l = 2;
    NeuronParams(1).g_Ca = 20;
    NeuronParams(1).g_K = 20;
    NeuronParams(1).Ca_leak = 60;
    NeuronParams(1).K_leak = -84;
...
NeuronParams(2).axisAligned = '';
    ...
    NeuronParams(2).v_cutoff = -10;
    NeuronParams(2).V1 = -5.2;
    NeuronParams(2).V2 = 18;
    NeuronParams(2).V3 = 18;
    NeuronParams(2).V4 = 17.4;
    NeuronParams(2).phi = 0.1;
    NeuronParams(2).T0 = 0.08;
    NeuronParams(2).g_l = 0.6;
...
% NeuronParams(13).neuronModel = 'ML';
% NeuronParams(13).v_cutoff = -10;
% 
%     NeuronParams(13).V1 = 4.80909056178;
%     NeuronParams(13).V2 = 18;
%     NeuronParams(13).V3 = 10.188104462;
%     NeuronParams(13).V4 = 17.4;
%     NeuronParams(13).phi = 0.0503391379494;
%     NeuronParams(13).T0 = 0.08;
%     NeuronParams(13).g_l = 0.5;
%     NeuronParams(13).g_Ca = 3.61558013569;
%     NeuronParams(13).g_K = 10.4382509195;
%     NeuronParams(13).Ca_leak = 60;
%     NeuronParams(13).K_leak = -84;
...
NeuronParams(1).Input(2).inputType = 'i_ou';
NeuronParams(1).Input(2).meanInput = 15;
NeuronParams(1).Input(2).stdInput = 36;
NeuronParams(1).Input(2).tau = 2;
% for i = 2:5
%     NeuronParams(i).Input(1).inputType = 'i_ou';
%     NeuronParams(i).Input(1).meanInput = 150;
...
%     NeuronParams(i).Input(1).amplitude = 4000;
%     NeuronParams(i).Input(1).timeOn = 20;
%     NeuronParams(i).Input(1).timeOff = 22;
% end
for i = 6:8
    NeuronParams(i).Input(2).inputType = 'i_ou';
    NeuronParams(i).Input(2).meanInput = 15;
    NeuronParams(i).Input(2).stdInput = 36;
    NeuronParams(i).Input(2).tau = 2;
end
% 
% for i = 9:12
%     NeuronParams(i).Input(1).inputType = 'i_ou';
...
%     NeuronParams(i).Input(1).tau = 1;
% end
%NeuronParams(3).Input(2).targets = 1:500;

% NeuronParams(4).Input(1).inputType = 'i_ou';
% NeuronParams(4).Input(1).meanInput = 30;
% NeuronParams(4).Input(1).stdInput = 20;
% NeuronParams(4).Input(1).tau = 1;
% NeuronParams(5).Input(1).inputType = 'i_ou';
% NeuronParams(5).Input(1).meanInput = 50;
% NeuronParams(5).Input(1).stdInput = 30;
% NeuronParams(5).Input(1).tau = 2;
% NeuronParams(6).Input(1).inputType = 'i_ou';
% NeuronParams(6).Input(1).meanInput = 30;
% NeuronParams(6).Input(1).stdInput = 10;
...
for i = 1:20
    ...
    NeuronParams(i).Input(1).amplitude = 0;
     ...
     NeuronParams(i).Input(1).timeOn = 250;
     NeuronParams(i).Input(1).timeOff = 260;
end

volumemultiplier = ((TissueParams.X/1000)*(TissueParams.Y/1000)*(TissueParams.Z/1000))/0.775;
%volumemultiplier = 1;
...
%TissueParams.StimulationField = uxyz;
...
RecordingSettings.v_m = 1:1:19472;
