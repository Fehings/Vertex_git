...
NeuronParams(1).Input(1).meanInput = 0;%330;
NeuronParams(1).Input(1).stdInput = 0;%90;
...
RecordingSettings.saveDir = '~/VERTEX_results_tutorial_2/neurontest';
...
RecordingSettings.v_m = 1:10:200;
