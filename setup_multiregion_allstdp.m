...
NeuronParams(3).modelProportion = 0.01; % will this work?;
...
ConnectionParams(1).tPost{1} = 1+rand();
...
ConnectionParams(1).tPost{2} = 1+rand();
...
ConnectionParams(1).rate{3} = 0.01;
ConnectionParams(1).tPre{3} = 2;
ConnectionParams(1).tPost{3} = 1+rand();
ConnectionParams(1).wmin{3} = 0;
...
ConnectionParams(2).tPost{1} = 1+rand();
ConnectionParams(2).wmin{1} = 0;
ConnectionParams(2).wmax{1} = 100;
ConnectionParams(2).E_reversal{1} =0;
...
ConnectionParams(2).tPost{2} = 1+rand();
ConnectionParams(2).wmin{2} = 0;
ConnectionParams(2).wmax{2} = 100;
ConnectionParams(2).E_reversal{2} =0;
...
ConnectionParams(2).rate{3} = 0.01;
ConnectionParams(2).tPre{3} = 2;
ConnectionParams(2).tPost{3} = 1+rand();
ConnectionParams(2).wmin{3} = 0;
ConnectionParams(2).wmax{3} = 100;
ConnectionParams(2).E_reversal{3} =0;
...
ConnectionParams(3).numConnectionsToAllFromOne{1} = 1700;
...
ConnectionParams(3).rate{2} = 0.01;
ConnectionParams(3).tPre{2} = 2;
ConnectionParams(3).tPost{2} = 1+rand();
ConnectionParams(3).wmin{2} = 0;
...
ConnectionParams(3).rate{3} = 0.01;
ConnectionParams(3).tPre{3} = 2;
ConnectionParams(3).tPost{3} = 1+rand();
ConnectionParams(3).wmin{3} = 0;
