...
ConnectionParams(1).preRate{1} = -stdprate;%0.01;
ConnectionParams(1).postRate{1} = stdprate;%0.01;
...
ConnectionParams(1).preRate{2} = -stdprate;%0.01;
ConnectionParams(1).postRate{2} = stdprate;%0.01;
...
ConnectionParams(1).preRate{3} = -stdprate;%0.01;
ConnectionParams(1).postRate{3} = stdprate;%0.01;
...
ConnectionParams(3).synapseType{1} = 'g_exp_stdp'; %using plasticity on these synapses so the connection can change weight
...
ConnectionParams(3).preRate{1} = -stdprate;%0.01;
ConnectionParams(3).postRate{1} = stdprate;%0.01;
...
ConnectionParams(3).synapseType{2} = 'g_exp_stdp';
ConnectionParams(3).targetCompartments{2} = {};
ConnectionParams(3).weights{2} = 0;
ConnectionParams(3).tau{2} = 1;
ConnectionParams(3).preRate{2} = -stdprate;%0.01;
ConnectionParams(3).postRate{2} = stdprate;%0.01;
...
ConnectionParams(3).synapseType{3} = 'g_exp_stdp';
ConnectionParams(3).targetCompartments{3} = {};
ConnectionParams(3).weights{3} = 0;
ConnectionParams(3).tau{3} = 1;
ConnectionParams(3).preRate{3} = -stdprate;%0.01;
ConnectionParams(3).postRate{3} = stdprate;%0.01;
