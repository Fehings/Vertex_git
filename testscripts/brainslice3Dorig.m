...
applyBoundaryCondition(model,'face',[2],'h',1.0,'r',2); %the 'r' 5.0 sets up a 5(mv?) voltage here
applyBoundaryCondition(model,'face',[1],'h',1.0,'r',6); %the 'r' -5.0 sets up a -5 (mv?) voltage at this electrode. 
