model = createpde();
importGeometry(model,'tissuelayer1_extr.stl');
...
applyBoundaryCondition(model,'face',[7,15:18],'h',1.0,'r',5.0); %the 'r' 1.0 sets up a 1(mv?) voltage here
applyBoundaryCondition(model,'face',[10:14],'h',1.0,'r',-5.0); %the 'r' -1.0 sets up a -1 (mv?) voltage at this electrode. 
