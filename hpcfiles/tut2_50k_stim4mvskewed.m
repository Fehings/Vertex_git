...
TissueParams.StimulationField = load('pdeResult4mvAnodalSkewed'); % slicecutoutsmallnew

TissueParams.StimulationField = TissueParams.StimulationField.l23_anodal4mvskewed
...
RecordingSettings.saveDir = '~/VERTEX_Results/tut2_4mvskewedstim50kneuDen';
