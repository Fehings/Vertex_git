...
TissueParams.StimulationField = load('pdeResult4mvAnodalUnskewed'); % slicecutoutsmallnew
TissueParams.StimulationField = TissueParams.StimulationField.l23_anodal4mvunskewed;
TissueParams.StimulationOn =1000;% [10 40];
TissueParams.StimulationOff =5000;% [15 45];
%% Neuron parameters
...
RecordingSettings.saveDir = '~/VERTEX_Results/tut2_4mvunskewedstim50kneuDen';
