...
NP(1).axisAligned = 'z';
NP(1).Input(1).inputType = 'i_step';
NP(1).Input(1).amplitude = 360; % original value at 360 for gamma oscillations
NP(1).Input(1).timeOn = 0;
NP(1).Input(1).timeOff = SS.simulationTime;
...
NP(2).axisAligned = '';
NP(2).Input(1).inputType = 'i_step';
NP(2).Input(1).amplitude = 200; %200
NP(2).Input(1).timeOn = 0;
NP(2).Input(1).timeOff = SS.simulationTime;
...
NP(3).b = 75;
NP(3).v_reset = -62;
NP(3).Input(1).inputType = 'i_step';
NP(3).Input(1).amplitude = 160;
NP(3).Input(1).timeOn = 0;
NP(3).Input(1).timeOff = SS.simulationTime;
...
NP(4).v_reset = -70;
NP(4).somaLayer = 3;
NP(4).Input(1).inputType = 'i_step';
NP(4).Input(1).amplitude = 200;
NP(4).Input(1).timeOn = 0;
NP(4).Input(1).timeOff = SS.simulationTime;
...
NP(6).somaLayer = 3;
NP(6).Input(1).inputType = 'i_step';
NP(6).Input(1).amplitude = 250;
NP(6).Input(1).timeOn = 0;
NP(6).Input(1).timeOff = SS.simulationTime;
...
NP(9).axisAligned = 'z';
NP(9).Input(1).inputType = 'i_step';
NP(9).Input(1).amplitude = 860; % original value at 860 for gamma oscillations
NP(9).Input(1).timeOn = 0;
NP(9).Input(1).timeOff = SS.simulationTime;
...
NP(13).v_reset = -65;
NP(13).somaLayer = 5;
NP(13).Input(1).inputType = 'i_step';
NP(13).Input(1).amplitude =660;
NP(13).Input(1).timeOn = 0;
NP(13).Input(1).timeOff = SS.simulationTime;
