...
NP(1).Input(1).meanInput = 0; % original value at 360 for gamma oscillations
NP(1).Input(1).tau = 2;
NP(1).Input(1).stdInput = 0;
...
NP(2).Input(1).meanInput = 0; %200
NP(2).Input(1).tau = 2;
NP(2).Input(1).stdInput = 0;
...
NP(3).Input(1).meanInput = 0;
NP(3).Input(1).tau = 2;
NP(3).Input(1).stdInput = 0;
...
NP(4).Input(1).meanInput = 0;
NP(4).Input(1).tau = 2;
NP(4).Input(1).stdInput = 0;
...
NP(6).Input(1).meanInput = 0;
NP(6).Input(1).tau = 2;
NP(6).Input(1).stdInput = 0;
...
NP(9).Input(1).meanInput = 0; % original value at 860 for gamma oscillations
NP(9).Input(1).tau = 2;
NP(9).Input(1).stdInput = 0;
...
NP(13).Input(1).meanInput =0;
NP(13).Input(1).tau = 2;
NP(13).Input(1).stdInput = 0;
