...
% NeuronParams(1).Input(2).amplitude = 1000; 
  ...
  stlresult = load('anodal_4mvmmstimfield_cvc')
...
formatspec = '/Users/a6028564/Documents/MATLAB/Vertex_Results/PaperResults_Multiregion/L23_2regdirectedab_anodalstim_noiseseed%d';
...
for rseed = 1:length(noises)
   ...
   % run the simulation and time:
    tic
    runSimulationMultiregional({params,params2},{connections, connections2},{electrodes, electrodes2},regionConnect);
    toc
end
