...
NeuronParams(1).modelProportion = 0.6;
...
NeuronParams(1).Input(1).meanInput = 280;
...
NeuronParams(2).modelProportion = 0.3;
...
NeuronParams(2).Input(1).meanInput = 210;
...
NeuronParams(3).modelProportion = 0.1; % will this work?;
...
ConnectionParams(1).synapseType{3} = 'i_exp';
...
ConnectionParams(3).numConnectionsToAllFromOne{1} = 3000;%1700
ConnectionParams(3).synapseType{1} = 'i_exp';%'g_stdp'; %using plasticity on these synapses so the connection can change weight
ConnectionParams(3).targetCompartments{1} = {'basalID', ...
                                             'apicalID'};
ConnectionParams(3).weights{1} = 1;%0.5
...
%ConnectionParams(3).E_reversal =0;
...
ConnectionParams(3).synapseType{2} = 'i_exp';
...
ConnectionParams(3).synapseType{3} = 'i_exp';
