...
ConnectionParams(1).synapseType{3} = 'g_exp';
...
ConnectionParams(3).synapseType{1} = 'g_exp'; %using plasticity on these synapses so the connection can change weight
...
ConnectionParams(3).synapseType{3} = 'g_exp';
